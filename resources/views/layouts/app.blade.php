...
<body class="bg-white dark:bg-black min-h-screen flex flex-col text-black dark:text-white transition-colors duration-300">
...
<header class="bg-orange-500 dark:bg-gray-900 text-white shadow-md transition-colors duration-300">
    ...
    <nav id="mobile-menu" class="hidden flex-col px-4 pb-4 md:hidden bg-orange-600 dark:bg-gray-900">
        <a href="{{ url('/') }}" class="flex items-center gap-1 py-2 hover:bg-orange-500 dark:hover:bg-gray-700 rounded">
            <i class="fas fa-download"></i> Download
        </a>
        <a href="{{ url('/aboutme') }}" class="flex items-center gap-1 py-2 hover:bg-orange-500 dark:hover:bg-gray-700 rounded">
            <i class="fas fa-user"></i> About Me
        </a>
        
        <!-- Dark mode toggle mobile -->
        <button id="dark-toggle-mobile" class="flex items-center gap-1 py-2 hover:bg-orange-500 dark:hover:bg-gray-700 rounded w-full justify-center">
            <i class="fas fa-moon"></i>
        </button>
    </nav>
</header>
